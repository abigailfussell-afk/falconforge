...
- **A ninth display-initials implementation, and it disagrees with the canonical one.**
...
- **An interrupted `test:db` run poisons the next one, with an error about the fixture rather
