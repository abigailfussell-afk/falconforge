...
export default function DashboardHome({ setActiveTab }: DashboardHomeProps) {
    ...
    const quickActions = [
        ...
        { id: 'portfolio', label: 'Portfolio Helper', desc: 'Summarize your team\'s accomplishments', icon: Sparkles, color: 'bg-pink-500' },
        { id: 'judging', label: 'Judging Prep', desc: 'Be ready to answer any question', icon: Sparkles, color: 'bg-purple-500' },
    ];
